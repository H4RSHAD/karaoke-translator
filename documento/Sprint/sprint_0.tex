...
\begin{enumerate}[label=\alph*)]
    ...
    \begin{longtable}{|p{4cm}|p{6cm}|p{6cm}|}
        ...
        \begin{longtable}{|p{7cm}|p{4cm}|p{5cm}|}
            ...
            \endhead
             % Aquí centramos "Franz" en ambas direcciones
             %\multicolumn{1}{|c|}{\vfill\centering \textbf{Franz}\vfill}\rowcolor{lightblue} 
...
\begin{longtable}{|p{4cm}|P{5cm}|P{5.3cm}|P{2.2cm}|}
    ...
    \hline
    \rowcolor{lightgray} \textbf{Proyecto} & \multicolumn{3}{l|}{ Sistema Avanzado de Transcripción y Traducción Multilingue de audio a vídeo karaoke con Inteligencia Artificial} \\
    \hline
    \rowcolor{aliceblue} \textbf{Product Owner} & \multicolumn{3}{l|}{ARTEAGA GUZMAN MIGUEL ANGELN } \\
    \hline
    \rowcolor{lightgray} \textbf{Versión} & \textbf{ 1.0} & \textbf{Fecha} & \textbf{03/09/2025} \\
    \hline
